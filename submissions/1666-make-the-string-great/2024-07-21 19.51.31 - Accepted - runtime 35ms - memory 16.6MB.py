class Solution:
    ...
    #using ascii values instead of creating a dict

    #diff between upper and lower letter is 32 or use ord function
        stack = []

        for letter in s:
            if stack:
                if abs(ord(letter)- ord(stack[-1]))==32:
                    stack.pop()
                else:
                    stack.append(letter)
            else:
    ...
    '''      #we want to make our string good
            ...
            stack = []
            hashMap ={"a":"A","b":"B","c":"C","d":"D","e":"E","f":"F","g": "G","h":"H","i":"I","j":"J","k":"K","l":"L","m":"M","n":"N","o":"O","p":"P","q":"Q","r":"R","s":"S","t":"T","u":"U","v":"V","w":"W","x":"X","y":"Y","z":"Z"}
